...
//Metodo para crear el tratamiento
...
//Metodo para ver el detalle del tratamiento
const registrarTratamiento = async (req,res)=>{
    ...
    const tratamiento = await (await Tratamiento.create(req.body)).populate
...
//Metodo para eliminar le tratamiento
